...
<link rel="stylesheet" type="text/css" href="css/jquery-ui-1.8.2.redmon.css"/>
...
<div id="wrapper">
    <div id="content">
        ...
        $tournament = Tournament::getAllTournaments(true, true,true);
        ?>
        <div id="current_tournment" class="current_tournment">
            <h1>El torneo actual es: <span class="torneo_actual" id="span_torneo_actual"><?php echo $tournament->getName()?> </span></h1>
        </div>
        <br/>
        <br/>
        <br/>
        ...
        <div id="addTournament">
            <p>Formulario Torneos:</p>
            <form id="form_tournaments" name="form_tournaments" method="post"  action="" onsubmit="return false;">
                <p>Nombre:
                    <label>
                        <input type="text" name="nombre_torneo" id="form_tournaments_nombre_torneo" />
                    </label>
                </p>
                <p>
                    <label>
                        <input type="submit" name="enviar_torneo" id="form_tournaments_enviar_torneo" value="Guardar" />
                    </label>
                </p>
            </form>
            <div id="form_tournaments_procesando"></div>
            <div id="form_tournaments_errors"></div>
        </div>
        <h3><a href="javascript:void(0)" id="tournaments_admin_table_link">Torneos</a></h3>
        <div id="tournaments_table_list">
           <?php $tournamentList = Tournament::getAllTournaments(false, true, true); ?>
            <table width="200" border="1" id="tournaments_admin_table">
                <tr>
                    <th scope="col">Id</th>
                ...
                <tr id="tournament_tr_<?php echo $tournament->getId() ?>">
                    <td><?php echo $tournament->getId() ?></td>
                    <td><?php echo $tournament->getName() ?></td>
                    <td><a href="javascript:void(0)" onclick="//startDelete(<?php echo $tournament->getId() ?>,-1)" >Eliminar</a></td>
                </tr>
                    <?php endforeach; ?>
            </table>
        </div>
        ...
        <div id="rounds_table_list">
                ...
                <?php $roundList = Round::retrieveAll(0, true, true, false, true); ?>
            <table width="200" border="1" id="rounds_admin_table">
                ...
                <tr id="round_tr_<?php echo $round->getId() ?>">
                    ...
                    <td><?php echo $round->getTournamentName() ?></td>
        ...
        <br/>
        <br/>
        <h2>Seleccione el torneo a manejar</h2>
        <div id="tournament_selection">
            <div id="tournament_radios">
                <?php foreach ($tournamentList as $tournament): ?>
                    <input type="radio" id="radio_tournament_<?php echo $tournament->getId() ?>" name="tournament_radio" onclick="loadTournamentData(false)" value="<?php echo $tournament->getId() ?>" <?php if($tournament->getCurrent()) echo 'CHECKED'?>/> <label for="radio_tournament_<?php echo $tournament->getId() ?>"><?php echo $tournament->getName() ?></label>
                <?php endforeach; ?>
            </div>
        </div>
...
<div id="sidebar">
    <ul>
        <li><h3><a href="#" class="folder_table">Manejar la liga</a></h3>
            <ul>
                <li><a href="javascript:void(0)" class="folder_table" id="menu_agregar_torneo">Agregar Torneo</a></li>
